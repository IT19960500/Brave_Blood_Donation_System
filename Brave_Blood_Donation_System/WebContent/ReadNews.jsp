...
News news=NewsDao.getNewsDetailsById(newsId);
%>
<!DOCTYPE html>
<html>
<head>
						  ...
						  <tr style="font-weight: bold;">
							    	<td>
							    		<div class="card mb-3" style="max-width: 850px;">
  											<div class="row g-0">
    											<div class="col-md-4">
      												<img style="height:30vw; object-fit:cover;" src="images/<%= news.getNewsPhoto() %>" 
      												alt="Card image cap" class="img-fluid rounded-start" alt="...">
    											</div>
    												<div class="col-md-8">
      													<div class="card-body">
						        							<h1 class="card-title"style="color:red; text-decoration:underline;">
						        							<%= news.getNewsHeading() %></h1>
        													<h5 style="color:#E35C0E;"> <%= news.getNewsDescription() %></h5>
        													<p class="card-text"><%= news.getNewsArticle() %></p>
      													</div>
    												</div>
  												</div>
											</div>
