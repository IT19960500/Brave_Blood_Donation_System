...
<div class="container table-area">
			  	...
			  	<table  id="healthTable">
					  ...
					  <%
					  String healthAuthorID= request.getParameter("searchData");
					  	List<Health> searchHealth = HealthDao.getSearchNews(healthAuthorID);
					  	
					  	for(Health health1:searchHealth){
					  		...
					  		<tr style="font-weight: bold;">
								...
								<a href="#healthDetailsEdit"
										...
										<a href="health2.jsp" class="btn btn-success" style="margin-left:10px;" type="button"><i class="fas fa-angle-left fa-lg"></i></a>	
      </div>
    </div>
  </div>
</div>
