...
@MultipartConfig
@WebServlet("/editCampDetailsServlet")
public class editCampDetailsServlet extends HttpServlet {
				...
				if(emailValid == false) {
					...
					if(timeValid == false) {
						...
						if(dateValid == false){
							...
							//pass the value
							boolean isTrue = donationCampManagemetDButill.updateCampDetails(campId, campCategory, organizationName, campDate, campTime, campAddress, campLocation, exceptDonors, campArrangement, organizerName, organizerEmail);
